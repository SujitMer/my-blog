                    ...
                    <div className="footer-content">
                        ...
                        <div className="footer-content-column">
                            <div className="footer-call-to-action">
                                ...
                                <a className="footer-call-to-action-button button" href="#" target="_self"> Back to Top </a>
                            </div>
                            <div className="footer-call-to-action">
                        ...
                        <div className="footer-social-links"> <svg className="footer-social-amoeba-svg"
                            ...
                            <a className="footer-social-link github" href="#" target="_blank">
                                ...
                                <svg className="footer-social-icon-svg github" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                                    <path className="footer-social-icon-path"
                    ...
                    <div className="footer-copyright">
                        <div className="footer-copyright-wrapper">
                            <p className="footer-copyright-text">
                                <a className="footer-copyright-link" href="#" target="_self"> ©2025. | Designed By: Sujit Mer. |
